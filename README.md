...
To donwload the repository and setup all the dependencies, run the following script:
...
Given that you have a user with enough preferences, in order to publish the library in npmjs.com run the following script:
